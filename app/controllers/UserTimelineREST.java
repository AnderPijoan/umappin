...
public class UserTimelineREST extends ItemREST {

	public static Result all(String userId) {
		final User user = Application.getLocalUser(session());
		if (user == null){
			return badRequest(Constants.USER_NOT_LOGGED_IN.toString());
		}
		Timeline timeline = Timeline.findById(new ObjectId(userId), Timeline.class);
		if (timeline == null) {
	...
	public static Result getPublications(String userId) {
		final User user = Application.getLocalUser(session());
		if (user == null){
			return badRequest(Constants.USER_NOT_LOGGED_IN.toString());
		}
	...
	public static Result getLastPublications(String userId, int amount) {
		final User user = Application.getLocalUser(session());
		if (user == null){
			return badRequest(Constants.USER_NOT_LOGGED_IN.toString());
		}
	...
	public static Result getRangePublications(String userId, int from, int to) {
		final User user = Application.getLocalUser(session());
		if (user == null){
			return badRequest(Constants.USER_NOT_LOGGED_IN.toString());
		}
	...
	public static Result getPublication(String userId, String publicationId) {
		final User user = Application.getLocalUser(session());
		if (user == null){
			return badRequest(Constants.USER_NOT_LOGGED_IN.toString());
		}
	...
	public static Result getPublicationLikes(String userId, String publicationId) {
		final User user = Application.getLocalUser(session());
		if (user == null){
			return badRequest(Constants.USER_NOT_LOGGED_IN.toString());
		}
	...
	public static Result addPublication(String userId) {
		final User user = Application.getLocalUser(session());
		...
		try {
			...
			timeline = Timeline.findById(new ObjectId(userId), Timeline.class);

			// If is users first discussion, create new User2Discussion
			if (timeline == null){
				timeline = new Timeline();
				/****************************************/
				timeline.id = new ObjectId(userId); // IMPORTANT
				/****************************************/
				timeline.save();
			}
	...
	public static Result deletePublication(String userId, String publicationId){
		final User user = Application.getLocalUser(session());
		if (user == null){
			return badRequest(Constants.USER_NOT_LOGGED_IN.toString());
		}
	...
	public static Result getMessage(String userId, String messageId) {
		final User user = Application.getLocalUser(session());
		if (user == null){
			return badRequest(Constants.USER_NOT_LOGGED_IN.toString());
		}
	...
	public static Result updateMessage(String userId, String messageId) {
		final User user = Application.getLocalUser(session());
		if (user == null){
			return badRequest(Constants.USER_NOT_LOGGED_IN.toString());
		}
	...
	public static Result reply(String userId) {
		final User user = Application.getLocalUser(session());
		if (user == null){
			return badRequest(Constants.USER_NOT_LOGGED_IN.toString());
		}
	...
	public static Result replyToMessage(String userId, String id){
		final User user = Application.getLocalUser(session());
		if (user == null){
			return badRequest(Constants.USER_NOT_LOGGED_IN.toString());
		}
	...
	public static Result deleteMessage(String userId, String id){
		final User user = Application.getLocalUser(session());
		if (user == null){
			return badRequest(Constants.USER_NOT_LOGGED_IN.toString());
		}
