...
Maps.initFeaturesMap = () ->
  requirejs ['/assets/js/maps/models/map_model.js'], () ->
    requirejs ['/assets/js/maps/models/map_feature_model.js'], () ->
      requirejs ['/assets/js/maps/models/map_osmfeature_model.js'], () ->
        requirejs ['/assets/js/maps/models/map_osmnode_model.js'], () ->
          requirejs ['/assets/js/maps/models/map_osmway_model.js'], () ->
            requirejs ['/assets/js/maps/models/map_osmrelation_model.js'], () ->
              requirejs ['/assets/js/maps/models/map_feature_like_model.js'], () ->
                requirejs [
